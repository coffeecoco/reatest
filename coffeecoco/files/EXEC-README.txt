...
Files within exec-once-* will run only the first time you run Vagrant, unless you SSH into the VM and remove 
    the /.coffeecoco-stuff/exec-once-ran and/or /.coffeecoco-stuff/exec-once-unprivileged-ran files and re-run Vagrant.
...
Files within startup-once-* will only run on the next time you run Vagrant, unless you SSH into the VM and remove 
    the /.coffeecoco-stuff/startup-once-ran and/or /.coffeecoco-stuff/startup-once-unprivileged-ran files and re-run Vagrant.
