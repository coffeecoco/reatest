class coffeecoco::params (
  $extra_config_files = []
) {

  $coffeecoco_base_dir     = '/vagrant/coffeecoco'
  $coffeecoco_manifest_dir = "${coffeecoco_base_dir}/puppet/manifests/coffeecoco"

  $base_configs = [
    "${coffeecoco_base_dir}/config.yaml",
    "${coffeecoco_base_dir}/config-${::provisioner_type}.yaml",
  ]

  $custom_config = ["${coffeecoco_base_dir}/config-custom.yaml"]
